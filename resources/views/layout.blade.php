...
<html lang="en" class="h-100" data-bs-theme="auto">
  <!--ASSET - color-modes-js-->
  <head><script src="{{asset('js/color-modes.js')}}"></script>
<!--cuando se pone doble llave se transforma a codigo php-->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="">
    <meta name="author" content="Mark Otto, Jacob Thornton, and Bootstrap contributors">
    <meta name="generator" content="Hugo 0.111.3">
    <title> @yield('title') -- ejemplo-uno.com</title>
...
<link rel="mask-icon" href="img/favicons/safari-pinned-tab" color="#712cf9">
